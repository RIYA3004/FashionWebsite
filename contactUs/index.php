        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <h1>Contact form <a href="HomePage.html">Plug & Play</a></h1>
                    ...
                    <form id="contact-form" method="post" role="form">
                        ...
                        <div class="controls">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p class="text-muted"><strong>*</strong> These fields are required. Contact form by <a href="HomePage.html" target="_blank">Plug & Play</a>.</p>
                                </div>
                            </div>
                        </div>
